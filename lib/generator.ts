...
const HK_PREFIXES = {
  // 香港主要运营商真实号段 (2024-2025)
  csl: ['90', '91', '92', '93', '94', '95', '96'],           // CSL/1O1O/csl.
  three: ['51', '52', '53', '54', '61', '62', '63', '64'],  // 3香港
  smartone: ['55', '56', '57', '58', '59', '65', '66', '67', '68', '69'], // SmarTone
  cmhk: ['97', '98', '60']                                   // 中国移动香港
};
