...
const MOCK_APPS = [
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: "2.1K",
    icon: "https://api.dicebear.com/7.x/shapes/svg?seed=Oasis&backgroundColor=30D158",
    description: "Mindfulness daily."
  },
];
  ...
  return (
    ...
    <div className="group relative bg-white rounded-[20px] md:rounded-[2rem] p-5 md:p-6 flex flex-col 
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="w-[64px] h-[64px] md:w-20 md:h-20 rounded-[14px] md:rounded-[22px] overflow-hidden border border-black/5 shadow-sm shrink-0 relative z-10">
          <img 
            src={app.icon} 
            alt={app.name} 
        ...
        <div className="flex flex-col flex-1 pt-0.5 min-w-0">
          <div className="flex justify-between items-start">
            ...
            {/* Get Button (Mobile Compact): 放在这里方便手指点击热区 */}
            <button 
